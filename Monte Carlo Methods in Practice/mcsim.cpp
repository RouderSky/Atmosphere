...
#define RAND_0_1 (1.0 * rand() / (RAND_MAX - 1))

double getCosTheta(const double &g) // sampling the H-G scattering phase function
{
    if (g == 0) return 2 * RAND_0_1 - 1;
    double mu = (1 - g * g) / (1 - g + 2 * g * RAND_0_1);
